...
class CelerySettings(BaseSettings):
    ...
    TOKEN_QUEUE: str = settings.TOKEN_QUEUE or 'tokens'
    EMAIL_QUEUE: str = settings.EMAIL_QUEUE or 'emails'
    ...
    def celery_config(self):
        return {
            ...
            'task_routes': {
                ...
                'tasks.tokens.*': {'queue': self.TOKEN_QUEUE},
                'tasks.emails.*': {'queue': self.EMAIL_QUEUE},
            },
